...
describe('Gigasecond', function() {
  ...
  it('tells a gigasecond anniversary since midnight', function() {
    var gs = Gigasecond(new Date(Date.UTC(2015, 8, 14)));
